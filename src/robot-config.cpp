...
signature AllSeeing__SIG_1 = signature (1, 0, 0, 0, 0, 0, 0, 3, 0);
signature AllSeeing__SIG_2 = signature (2, 0, 0, 0, 0, 0, 0, 3, 0);
vision AllSeeing = vision (PORT5, 40, AllSeeing__SIG_1, AllSeeing__SIG_2);
